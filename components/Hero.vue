<template>
  <div class="text-left text-gray-700 mb-8" role="region" aria-label="banner presentazione">
      <h1 class="text-2xl md:text-4xl lg:text-4xl font-semibold text-primary text-gray-700">Ciao, io sono Diana!</h1> 
